...
import { Plus, Edit2, Trash2, X, User, Mail, Briefcase, Shield, Upload } from 'lucide-react';
...
export const AdminStaffManager: React.FC = () => {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    if (editingUser) {
      const updatedUser = { ...editingUser, ...formData } as UserType;
      db.staff.update(updatedUser);
      setStaff(staff.map(u => u.id === editingUser.id ? updatedUser : u));
    } else {
      const newUser: UserType = {
        ...
        jobTitle: formData.jobTitle || 'Barbeiro',
        avatarUrl: formData.avatarUrl || 'https://images.unsplash.com/photo-1534360406560-593259695629?q=80&w=200&auto=format&fit=crop',
      };
      db.staff.create(newUser);
