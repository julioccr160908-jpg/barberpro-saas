...
import { Check, ChevronRight, ChevronLeft, Calendar as CalendarIcon, Clock, Scissors, User as UserIcon } from 'lucide-react';
...
export const BookingFlow: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setExistingAppointments(db.appointments.list());
  }, []);
  ...
  const handleConfirmBooking = () => {
    if (selectedBarber && selectedService && selectedTime) {
      ...
      db.appointments.create({
        ...
        customerId: 'guest', // In a real app this comes from auth
